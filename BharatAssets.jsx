...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hc-amount { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 46px; font-weight: 800; color: white; margin-bottom: 4px; }
    ...
    .hc-m-val { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 18px; font-weight: 700; color: white; }
    ...
    .plan-rate-pct { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 20px; font-weight: 800; color: var(--blue); }
    ...
    .calc-result-main { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 52px; font-weight: 800; color: white; line-height: 1; margin-bottom: 6px; }
    ...
    .stat-band-num { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 42px; font-weight: 800; line-height: 1; margin-bottom: 8px; }
    ...
    .how-num { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 28px; font-weight: 800; color: white; }
    ...
    .footer-col-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 14px; font-weight: 700; color: white; margin-bottom: 20px; letter-spacing: 0.5px; }
    ...
    .inv-amount-big { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 32px; font-weight: 800; color: var(--ink); margin-bottom: 4px; }
    ...
    .pwb-amount { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 32px; font-weight: 800; margin-bottom: 16px; }
    ...
    .otp-input { width: 54px; height: 64px; border: 2px solid var(--slate-300); border-radius: var(--radius); font-family: 'Plus Jakarta Sans', sans-serif; font-size: 26px; font-weight: 800; text-align: center; color: var(--blue); outline: none; transition: var(--transition); background: white; }
  ...
  <nav className={`nav-root${scrolled ? " scrolled" : ""}`}>
    <div className="nav-inner">
      ...
      <ul className="nav-links">
        {[["home","Home"], ["plans","Plans"], ["calculator","Calculator"], ["assets","Assets"], ["how","How It Works"]].map(([p, label]) => (
...
const LoginPage = ({ setPage }) => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
      {/* Left panel */}
      <div style={{ background: "linear-gradient(155deg, #030B1A 0%, #001855 50%, #0052CC 100%)", padding: "60px 50px", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden" }}>
        ...
        <h2 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 36, fontWeight: 800, color: "white", lineHeight: 1.2, marginBottom: 20, position: "relative", zIndex: 1 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "40px", background: "var(--slate-50)", overflow: "auto" }}>
        <div style={{ width: "100%", maxWidth: 440 }}>
          {step === 1 ? (
            <>
              <h1 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 30, fontWeight: 800, marginBottom: 8 }}>Sign In</h1>
            ...
            <>
              <div style={{ textAlign: "center", marginBottom: 28 }}>
                ...
                <h1 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 28, fontWeight: 800, marginBottom: 8 }}>OTP Verification</h1>
...
const RegisterPage = ({ setPage }) => {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
      <div style={{ background: "linear-gradient(155deg, #030B1A 0%, #001855 50%, #0052CC 100%)", padding: "60px 50px", display: "flex", flexDirection: "column", justifyContent: "center", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "40px", background: "var(--slate-50)", overflow: "auto" }}>
        <div style={{ width: "100%", maxWidth: 460 }}>
          <h1 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 28, fontWeight: 800, marginBottom: 8 }}>Create Your Account</h1>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--slate-50)", display: "flex", alignItems: "center", justifyContent: "center", padding: 32 }}>
      <div style={{ background: "white", borderRadius: "var(--radius-xl)", border: "1.5px solid var(--slate-200)", padding: "56px 48px", maxWidth: 480, width: "100%", textAlign: "center", boxShadow: "var(--shadow-lg)" }}>
        ...
        <h2 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 26, fontWeight: 800, marginBottom: 12 }}>Verify Your Email</h2>
...
// DASHBOARD
// ============================================================
const DashboardSidebar = ({ activePage, setActivePage, setPage }) => {
  const navItems = [
    { section: "Portfolio" },
    ...
    <div className="sidebar">
      ...
      <div className="sb-nav">
        {navItems.map((item, i) => {
          ...
          return (
            <div key={i} className={`sb-nav-item${activePage === item.id ? " active" : ""}`} onClick={() => setActivePage(item.id)}>
      ...
      <div className="sb-logout">
        <div className="sb-logout-btn" onClick={() => setPage("home")}>
          <span>🚪</span> Logout
        </div>
      </div>
    </div>
...
const DashboardOverview = ({ setActivePage }) => {
  ...
  <div className="dash-area">
    ...
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
      <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 20, fontWeight: 800 }}>Active Investments</h3>
          ...
          <div className="dash-card-body">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 28 }}>
              <div style={{ background: "linear-gradient(135deg, var(--blue), #0069D9)", borderRadius: 12, padding: 18, color: "white" }}>
                ...
                <div style={{ fontFamily: "Plus Jakarta Sans", fontSize: 24, fontWeight: 800 }}>₹1,27,500</div>
              </div>
              <div style={{ background: "linear-gradient(135deg, #00875A, #00A86B)", borderRadius: 12, padding: 18, color: "white" }}>
                ...
                <div style={{ fontFamily: "Plus Jakarta Sans", fontSize: 24, fontWeight: 800 }}>₹1,24,750</div>
              </div>
            </div>
            ...
            {step === 1 ? (
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 22, fontWeight: 800, marginBottom: 8 }}>Authorize Withdrawal</h3>
      ...
      <div style={{ maxWidth: 700 }}>
        ...
        <div className="dash-card">
          <div className="dash-card-body">
            {kycStep === 1 && (
              <>
                <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 20, fontWeight: 800, marginBottom: 24 }}>Select Document Type</h3>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 28 }}>
            ...
            {kycStep === 2 && (
              <>
                <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 20, fontWeight: 800, marginBottom: 24 }}>Upload Documents</h3>
            ...
            {kycStep === 3 && (
              <>
                <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 20, fontWeight: 800, marginBottom: 8 }}>Take a Selfie</h3>
            ...
            {kycStep === 4 && (
              <>
                <div style={{ textAlign: "center", padding: "20px 0" }}>
                  ...
                  <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Ready to Submit</h3>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: 28 }}>
        <div>
          <div style={{ marginBottom: 28 }}>
            <h3 style={{ fontFamily: "Plus Jakarta Sans", fontSize: 17, fontWeight: 700, marginBottom: 16 }}>Select Investment Plan</h3>
                ...
                <div key={plan.id} onClick={() => setSelected(plan.id)} style={{ background: selected === plan.id ? "var(--blue-pale)" : "white", border: `2px solid ${selected === plan.id ? "var(--blue)" : "var(--slate-200)"}`, borderRadius: "var(--radius)", padding: "20px 24px", cursor: "pointer", transition: "all 0.2s", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontFamily: "Plus Jakarta Sans", fontSize: 22, fontWeight: 800, color: "var(--blue)" }}>{plan.profit}%</div>
          ...
          <div className="dash-card">
            ...
            <div className="dash-card-body">
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ fontFamily: "Plus Jakarta Sans", fontSize: 38, fontWeight: 800, color: "var(--ink)" }}>₹{total.toLocaleString("en-IN")}</div>
              </div>
...
const DashboardPage = ({ setPage }) => {
  ...
  return (
    <div className="app-layout">
      <DashboardSidebar activePage={activePage} setActivePage={setActivePage} setPage={setPage} />
    ...
    <div className="support-fab" onClick={() => setClicked(true)} title={isActive ? "Live Support Active" : "Support: 10AM–4PM IST"}>
      ...
      {clicked && (
        <div style={{ position: "absolute", bottom: 70, right: 0, background: "white", borderRadius: "var(--radius-lg)", padding: 20, width: 280, boxShadow: "var(--shadow-lg)", border: "1.5px solid var(--slate-200)" }}>
          <div style={{ fontWeight: 800, marginBottom: 8, fontFamily: "Plus Jakarta Sans" }}>Support Chat</div>
          {isActive ? (
