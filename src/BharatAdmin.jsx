...
const AdminStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-logo-text { font-family: 'Poppins', sans-serif; font-size: 20px; font-weight: 800; color: white; letter-spacing: -0.03em; }
    ...
    .page-header h2 { font-family: 'Poppins', sans-serif; font-size: 24px; font-weight: 800; margin-bottom: 4px; }
    ...
    @media (max-width: 768px) {
      ...
      /* Live pill hidden on mobile topbar */
      .topbar-live-pill { display: none; }

      /* Dash area */
      .dash-area { padding: 16px; }

      /* Stat cards: 1 col on phone */
      ...
      /* ROI manager grid: single col */
      .roi-row { grid-template-columns: 1fr !important; }

      /* Asset log form grid */
      .asset-form-grid { grid-template-columns: 1fr !important; }

      /* Support settings grid */
      .support-hours-grid { grid-template-columns: 1fr !important; }

      /* User management search row */
      .user-search-row { flex-direction: column !important; }
      .user-search-row input,
      .user-search-row select { max-width: 100% !important; }

      /* Login box */
      .login-box { padding: 32px 20px; margin: 16px; }

      /* Toast */
      .toast { right: 12px; left: 12px; max-width: 100%; font-size: 13px; padding: 12px 16px; }

      /* Page header */
      .page-header h2 { font-size: 20px; }

      /* Sidebar info box */
      .sb-info-box { display: none; }
    }

    @media (max-width: 420px) {
      .stat-cards-grid { grid-template-columns: 1fr; }
      .dash-topbar-left h1 { font-size: 14px; }
    }
  `}</style>
);
    ...
    <div className="login-wrap">
      <div className="login-box">
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
          ...
          <div>
            <div style={{ fontFamily: "'Poppins'", fontSize: 20, fontWeight: 800 }}>Admin<span style={{ color: "var(--orange)" }}>Panel</span></div>
    ...
    <>
      ...
      <div className="admin-layout">
        ...
        <div className={`sidebar${sidebarOpen ? " mobile-open" : ""}`}>
          ...
          <div className="sb-info-box" style={{ padding: "12px 16px", background: "rgba(0,82,204,0.12)", margin: "12px", borderRadius: "var(--radius-sm)", fontSize: 12, color: "rgba(255,255,255,0.6)", lineHeight: 1.6 }}>
          ...
          <div className="sb-nav">
            {adminNav.map((item, i) => {
              ...
              return (
                <div key={i} className={`sb-nav-item${activeSection === item.id ? " active" : ""}`} onClick={() => { setActiveSection(item.id); setSidebarOpen(false); }}>
        ...
        <div className="admin-content">
          <div className="dash-topbar">
            ...
            <div className="topbar-actions">
              <div className="live-pill topbar-live-pill"><div className="live-dot" /> Live Admin</div>
          ...
          <div className="dash-area">
            ...
            {activeSection === "users" && (
              <div>
                ...
                <div className="dash-card" style={{ marginBottom: 24 }}>
                  <div className="dash-card-body">
                    <div className="user-search-row" style={{ display: "flex", gap: 14 }}>
                ...
                <div className="dash-card">
                  <div className="dash-card-body">
                    {[
                      ...
                      <div key={key} className="roi-row" style={{ display: "grid", gridTemplateColumns: "1fr 180px", gap: 16, alignItems: "center", padding: "16px 0", borderBottom: "1px solid var(--slate-100)" }}>
                        <div>
                ...
                {[
                  ...
                  <div key={i} className="dash-card" style={{ marginBottom: 16 }}>
                    ...
                    <div className="dash-card-body">
                      ...
                      <div className="asset-form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14 }}>
                ...
                <div className="dash-card">
                  <div className="dash-card-body">
                    ...
                    <div style={{ padding: "20px 0", borderBottom: "1px solid var(--slate-100)" }}>
                      ...
                      <div className="support-hours-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
